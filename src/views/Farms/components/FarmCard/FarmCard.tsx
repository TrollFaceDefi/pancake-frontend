...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, btcPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'TROLL'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'TROLL' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
